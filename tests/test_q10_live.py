...
check(skill is not None and skill.get("name") and skill.get("description") and skill.get("tags"), "card has invoice_action_agent skill with nonempty name/description/tags")
